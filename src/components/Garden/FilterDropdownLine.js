...
const FilterDropdownLine = ({ selectedFilterLine, onFilterChangeLine }) => {
  ...
  return (
    <div style={{ position: 'relative', display: 'inline-block' }}>
      ...
      >
        {options[selectedFilterLine]} {/* Hiển thị chữ tương ứng */}
        <CaretDown
          size={20}
          style={{
      ...
      {isOpen && (
        ...
        >
          ...
          <li
            onClick={() => onFilterChangeLine('daily')}
            style={{
              padding: '10px',
              cursor: 'pointer',
          ...
          <li
            onClick={() => onFilterChangeLine('weekly')}
            style={{
              padding: '10px',
              cursor: 'pointer',
              transition: 'background-color 0.3s',
          ...
          <li
            onClick={() => onFilterChangeLine('monthly')}
            style={{
              padding: '10px',
              cursor: 'pointer',
              transition: 'background-color 0.3s',
